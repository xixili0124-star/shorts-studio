...
function selectMany(refs,primary,options={}){
  ...
  player.invalidate();renderInspector();updateToolbar();if(['captions','mosaic','silence'].includes(view))renderLibrary();
}
